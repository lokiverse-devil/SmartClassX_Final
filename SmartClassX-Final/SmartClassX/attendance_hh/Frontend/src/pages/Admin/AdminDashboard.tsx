...
import { FingerprintAttendanceHistory } from './FingerprintAttendanceHistory';
import { LeaveManagement } from './LeaveManagement';
import { Fingerprint, Users, FileText, BarChart3, Settings } from 'lucide-react';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onLogout }) => {
  ...
  const navItems = [
    ...
    { label: 'Fingerprint History', href: '/panel/admin/fingerprint', icon: Fingerprint },
  ...
  return (
    <PanelShell title="Attendo Admin" navItems={navItems} onLogout={onLogout}>
      <div className="rounded-2xl shadow glass p-4 sm:p-6">
        ...
        {location.pathname.endsWith('/fingerprint') && <FingerprintAttendanceHistory />}
