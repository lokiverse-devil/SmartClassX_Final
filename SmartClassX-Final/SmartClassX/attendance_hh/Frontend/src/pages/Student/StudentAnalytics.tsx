    ...
    <div className="space-y-6">
      ...
      <div className="glass p-6 rounded-xl shadow-lg hover-glow transition-all duration-300 transform hover:scale-105">
        ...
        <ul className="space-y-2 text-muted-foreground">
          <li><strong className="text-foreground">Name:</strong> {user.name}</li>
          <li><strong className="text-foreground">RollNo:</strong> {user.rollNo}</li>
          <li><strong className="text-foreground">Department:</strong> {user.department}</li>
          <li><strong className="text-foreground">Year:</strong> {user.year}</li>
          <li><strong className="text-foreground">Email:</strong> {user.email}</li>
